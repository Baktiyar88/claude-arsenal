...
## 📚 Ещё больше (непроверенное)
Большой список популярных Claude Code репо, который я **не проверял детально** — только звёзды и описания. Можете посмотреть сами: **[browse/](browse/README.md)** (25+ репо, все бесплатные).
---
