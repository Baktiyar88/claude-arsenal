...
Большой список популярных Claude Code репо, который я **не проверял детально** — только звёзды и описания. Можешь посмотреть сам: **[browse/](browse/README.md)** (25+ репо, все бесплатные).
---
