...
Многоагентные системы — это "команды" Claude-агентов. Вместо одного универсального Claude работает несколько специализированных агентов одновременно: один ищет баги, другой пишет код, третий делает код-ревью. Главный Claude координирует их работу.

Бери оркестратор, когда хочешь делегировать работу команде специалистов, а не одному "универсалу".
